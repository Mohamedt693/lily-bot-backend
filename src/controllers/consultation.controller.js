...
export const handleConsultation = async (req, res) => {
    try {
        ...
        2. بعد توفر نوع البشرة والمشكلة: استخدمي قائمة المنتجات التالية فقط للترشيح: ${JSON.stringify(dbProducts, null, 2)}
        ...
        5. عرض المنتجات بالصور والروابط والكوبونات: لكل منتج تقترحي عرضه، يجب الالتزام بالترتيب والتنسيق التالي نصاً دون تأليف:
            ...
            - روابط الشراء (links) وكوبونات الخصم (coupons) المرفقة معه في البيانات.
